/*
 *
 * Copyright 2023 DUNCKELFELD GmbH
 * Tom Kirchhartz <tk@dunckelfeld.de>
 *
 * Funktionen und Parameter sowie Tabellen laut Programmablaufplan 2023 von bmf-steuerrechner.de
 * https://www.bmf-steuerrechner.de/pruefdaten/pap2023.pdf
 * Erstumsetzung von Christoph Hahn, Wartung von Tom Kirchhartz
 *
 */

// *******************************
// BmfSteuerRechner2023
// *******************************
var BmfSteuerRechner2023 = function (elm) {
  this.init(elm);
};
BmfSteuerRechner2023.prototype = {
  ...
  prepareDataObject: function () {
    ...
    // auf der Bescheinigung für den Lohnsteuerabzug 2023 in Cent
    // (ggf. 0)
    t.JFREIB = 0;
    ...
    // Lohnsteuerabzug 2023 eingetragene Freibetrag für den Lohnzahlungszeitraum in
    // Cent
    t.LZZFREIB = 0;
    // Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber
    // nach § 39e EStG festgestellte oder in der Bescheinigung für den
    // Lohnsteuerabzug 2023 eingetragene Hinzurechnungsbetrag für den
    ...
    // oder der Bescheinigung für den Lohnsteu-erabzug 2023 (bei keiner
    ...
    // der Bescheinigung für den Lohnsteuerabzug 2023 für den
  ...
  func_UPTAB23: function () {
    ...
    if (t.X < t.GFB + 1) {
      ...
      t.RW = t.RW + 2397;
      t.RW = t.RW * t.Y;
      t.ST = Math.floor(t.RW + 966.53);
    } else if (t.X < 277826) {
      t.ST = Math.floor(t.X * 0.42 - 9972.98);
    } else {
      t.ST = Math.floor(t.X * 0.45 - 1807.73);
    }
    t.ST = t.ST * t.KZTAB;
  },
