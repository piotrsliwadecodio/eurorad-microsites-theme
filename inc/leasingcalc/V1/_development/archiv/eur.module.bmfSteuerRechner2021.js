/*
 *
 * Copyright 2021 DUNCKELFELD GmbH
 * Tom Kirchhartz <tk@dunckelfeld.de>
 *
 * Funktionen und Parameter sowie Tabellen laut Programmablaufplan 2021 von bmf-steuerrechner.de
 * https://www.bmf-steuerrechner.de/pruefdaten/pap2021.pdf
 * Erstumsetzung von Christoph Hahn, Wartung von Tom Kirchhartz
 *
 */

// *******************************
// BmfSteuerRechner2021
// *******************************
var BmfSteuerRechner2021 = function (elm) {
  this.init(elm);
};
BmfSteuerRechner2021.prototype = {
  ...
  prepareDataObject: function () {
    ...
    // Bescheinigung für den Lohnsteuerabzug 2021 in Cent (ggf. 0)
    t.JFREIB = 0;
    ...
    // Lohnsteuerabzug 2021 in Cent (ggf. 0)
    t.JHINZU = 0;
    ...
    // Lohnsteuerabzug 2021 eingetragene Freibetrag für den Lohnzahlungszeitraum in
    // Cent
    t.LZZFREIB = 0;
    // Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber
    // nach § 39e EStG festgestellte oder in der Bescheinigung für den
    // Lohnsteuerabzug 2021 eingetragene Hinzurechnungsbetrag für den
    ...
    // oder der Bescheinigung für den Lohnsteu-erabzug 2021 (bei keiner
    ...
    // der Bescheinigung für den Lohnsteuerabzug 2021 für den
  ...
  func_UPTAB21: function () {
    ...
    if (t.X < t.GFB + 1) {
      ...
      t.RW = t.RW + 2397;
      t.RW = t.RW * t.Y;
      t.ST = Math.floor(t.RW + 950.96);
    } else if (t.X < 274613) {
      t.ST = Math.floor(t.X * 0.42 - 9136.63);
    } else {
      t.ST = Math.floor(t.X * 0.45 - 17374.99);
    }
    t.ST = t.ST * t.KZTAB;
  },
  ...
  func_MSOLZSTS: function () {
    ...
    if (t.SOLZSZVE < 1) {
      ...
      t.X = t.decimalFloor(t.SOLZSZVE / t.KZTAB);
    }
    ...
    t.SOLZSBMG = t.decimalFloor(t.ST * t.F);
