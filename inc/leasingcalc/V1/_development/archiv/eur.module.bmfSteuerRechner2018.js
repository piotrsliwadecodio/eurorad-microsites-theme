/*
*
* Copyright 2018 DUNCKELFELD GmbH
* Tom Kirchhartz <tk@dunckelfeld.de>
*
* Funktionen und Parameter sowie Tabellen laut Programmablaufplan 2018 von bmf-steuerrechner.de
...
// *******************************
// BmfSteuerRechner2018
// *******************************
var BmfSteuerRechner2018 = function(elm) {
	this.init(elm);
};
BmfSteuerRechner2018.prototype = {
	...
	// *******************************
		...
		// Bescheinigung für den Lohnsteuerabzug 2018 in Cent (ggf. 0)
		t.JFREIB = 0;
		...
		// Lohnsteuerabzug 2018 in Cent (ggf. 0)
		t.JHINZU = 0;
		...
		// krankenversicherten Arbeitnehmer in Prozent (bspw. 1,00 für
		// 1,00 %) mit 2 Dezimalstellen
		t.KVZ = 1;
		...
		// Lohnsteuerabzug 2018 eingetragene Freibetrag für den Lohnzahlungszeitraum in
		// Cent
		t.LZZFREIB = 0;
		// Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber
		// nach § 39e EStG festgestellte oder in der Bescheinigung für den
		// Lohnsteuerabzug 2018 eingetragene Hinzurechnungsbetrag für den
		...
		// oder der Bescheinigung für den Lohnsteu-erabzug 2018 (bei keiner
		...
		// der Bescheinigung für den Lohnsteuerabzug 2018 für den
	...
	*/
	...
	func_UPTAB18: function () {
		...
		if (t.X < t.GFB + 1) {
			...
			t.RW = t.RW + 2397;
			t.RW = t.RW * t.Y;
			t.ST = Math.floor(t.RW + 948.49);
		} else if (t.X < 260533) {
			t.ST = Math.floor((t.X * 0.42) - 8621.75);
		} else {
			t.ST = Math.floor((t.X * 0.45) - 16437.7);
		}
		t.ST = t.ST * t.KZTAB;
	},
