/*
*
* Copyright 2017 DUNCKELFELD GmbH
* Tom Kirchhartz <tk@dunckelfeld.de>
*
* Funktionen und Parameter sowie Tabellen laut Programmablaufplan 2017 von bmf-steuerrechner.de
...
// *******************************
// BmfSteuerRechner2017
// *******************************
var BmfSteuerRechner2017 = function(elm) {
	this.init(elm);
};
BmfSteuerRechner2017.prototype = {
	...
	// *******************************
		...
		// Bescheinigung für den Lohnsteuerabzug 2017 in Cent (ggf. 0)
		t.JFREIB = 0;
		...
		// Lohnsteuerabzug 2017 in Cent (ggf. 0)
		t.JHINZU = 0;
		...
		// Lohnsteuerabzug 2017 eingetragene Freibetrag für den Lohnzahlungszeitraum in
		// Cent
		t.LZZFREIB = 0;
		// Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber
		// nach § 39e EStG festgestellte oder in der Bescheinigung für den
		// Lohnsteuerabzug 2017 eingetragene Hinzurechnungsbetrag für den
		...
		// oder der Bescheinigung für den Lohnsteu-erabzug 2017 (bei keiner
		...
		// der Bescheinigung für den Lohnsteuerabzug 2017 für den
	...
	*/
	...
	func_UPTAB17: function () {
		...
		if (t.X < t.GFB + 1) {
			...
			t.RW = t.RW + 2397;
			t.RW = t.RW * t.Y;
			t.ST = Math.floor(t.RW + 939.57);
		} else if (t.X < 256304) {
			t.ST = Math.floor((t.X * 0.42) - 8475.44);
		} else {
			t.ST = Math.floor((t.X * 0.45) - 16164.53);
		}
		t.ST = t.ST * t.KZTAB;
	},
