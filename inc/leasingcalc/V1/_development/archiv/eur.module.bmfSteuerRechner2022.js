/*
 *
 * Copyright 2022 DUNCKELFELD GmbH
 * Tom Kirchhartz <tk@dunckelfeld.de>
 *
 * Funktionen und Parameter sowie Tabellen laut Programmablaufplan 2022 von bmf-steuerrechner.de
 * https://www.bmf-steuerrechner.de/pruefdaten/pap2022.pdf
 * Erstumsetzung von Christoph Hahn, Wartung von Tom Kirchhartz
 *
 */

// *******************************
// BmfSteuerRechner2022
// *******************************
var BmfSteuerRechner2022 = function (elm) {
  this.init(elm);
};
BmfSteuerRechner2022.prototype = {
  ...
  prepareDataObject: function () {
    ...
    // sowie tarifermäßigt zu besteuernde Vorteile bei Vermögensbeteiligungen (§ 19a Absatz 4 EStG) in Cent
    t.ENTSCH = 0;
    ...
    // auf der Bescheinigung für den Lohnsteuerabzug 2022 in Cent
    // (ggf. 0)
    t.JFREIB = 0;
    ...
    // 1,10 %) mit 2 Dezimalstellen. Es ist der volle Zusatzbeitragssatz
    ...
    // Lohnsteuerabzug 2022 eingetragene Freibetrag für den Lohnzahlungszeitraum in
    // Cent
    t.LZZFREIB = 0;
    // Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber
    // nach § 39e EStG festgestellte oder in der Bescheinigung für den
    // Lohnsteuerabzug 2022 eingetragene Hinzurechnungsbetrag für den
    ...
    // oder der Bescheinigung für den Lohnsteu-erabzug 2022 (bei keiner
    ...
    // der Bescheinigung für den Lohnsteuerabzug 2022 für den
    ...
    // sowie nicht tarifermäßigt zu besteue
    t.SONSTENT = 0;
    ...
    // Hinweis: Der Entlastungsbetrag für Alleinerziehende beträgt ab 2022
    // 4.008 Euro. Der Erhöhungsbetrag von 2.100 Euro, der für die Jahre
    // 2020 und 2021 galt, ist ab 2022 weggefallen (Jahressteuergesetz
    // 2020).
    t.EFA = 0;
  ...
  func_UPTAB22: function () {
    ...
    if (t.X < t.GFB + 1) {
      ...
      t.RW = t.RW + 2397;
      t.RW = t.RW * t.Y;
      t.ST = Math.floor(t.RW + 869.32);
    } else if (t.X < 277826) {
      t.ST = Math.floor(t.X * 0.42 - 9336.45);
    } else {
      t.ST = Math.floor(t.X * 0.45 - 17671.2);
    }
    t.ST = t.ST * t.KZTAB;
  },
  ...
  func_MVMT: function () {
    ...
    if (t.VMT + t.VKAPA > 0) {
      ...
      t.SOLZVBMG = t.STV / 100 + t.JBMG;
      if (t.SOLZVBMG > t.SOLZFREI) {
