/*
*
* Copyright 2020 DUNCKELFELD GmbH
* Tom Kirchhartz <tk@dunckelfeld.de>
*
* Funktionen und Parameter sowie Tabellen laut Programmablaufplan 2020 von bmf-steuerrechner.de
* https://www.bmf-steuerrechner.de/pruefdaten/pap2020.pdf
* Erstumsetzung von Christoph Hahn, Wartung von Tom Kirchhartz
*
*/

// *******************************
// BmfSteuerRechner2020
// *******************************
var BmfSteuerRechner2020 = function(elm) {
	this.init(elm);
};
BmfSteuerRechner2020.prototype = {
	...
	// *******************************
		...
		// Bescheinigung für den Lohnsteuerabzug 2020 in Cent (ggf. 0)
		t.JFREIB = 0;
		...
		// Lohnsteuerabzug 2020 in Cent (ggf. 0)
		t.JHINZU = 0;
		...
		// Lohnsteuerabzug 2020 eingetragene Freibetrag für den Lohnzahlungszeitraum in
		// Cent
		t.LZZFREIB = 0;
		// Der als elektronisches Lohnsteuerabzugsmerkmal für den Arbeitgeber
		// nach § 39e EStG festgestellte oder in der Bescheinigung für den
		// Lohnsteuerabzug 2020 eingetragene Hinzurechnungsbetrag für den
		...
		// oder der Bescheinigung für den Lohnsteu-erabzug 2020 (bei keiner
		...
		// der Bescheinigung für den Lohnsteuerabzug 2020 für den
	...
	*/
	...
	func_UPTAB20: function () {
		...
		if (t.X < t.GFB + 1) {
			...
			t.RW = t.RW + 2397;
			t.RW = t.RW * t.Y;
			t.ST = Math.floor(t.RW + 972.79);
		} else if (t.X < 270501) {
			t.ST = Math.floor((t.X * 0.42) - 8963.74);
		} else {
			t.ST = Math.floor((t.X * 0.45) - 17078.74);
		}
		t.ST = t.ST * t.KZTAB;
	},
